...
class UserRequestRegister(BaseModel):
    ...
    password: str = Field(..., min_length=8, max_length=72, description="Пароль пользователя (обязательно, минимум 8 символов, максимум 72 символа из-за ограничений bcrypt)")
...
class User(UserRegister):
    """Схема ответа с ID пользователя."""
